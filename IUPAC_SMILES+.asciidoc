...
2+| **CHARGES**
| <<charge,Charge>>        | _charge_ ::= `'-'` \| `'-'` _DIGIT_? _DIGIT_ \| `'+'` \| `'+'` _DIGIT_? _DIGIT_ \| `'--'` deprecated \| `'...'` \| `'---------------'` deprecated \| `'++'` deprecated \| `'...'` \| `'+++++++++++++++'` deprecated
2+| **ATOM CLASS**
...
accept repeated symbols such as `'----'` and `'++++'` to mean charges of `-4` and `+4`, but this
